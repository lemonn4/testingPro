...
public class RegisterScreen {
	...
	public static void register(WebDriver driver, String id, String email, String name, String password, String address, String expectedMsg) {
		...
		if (expectedMsg.equals("NULL")) {
			...
			Utilities.captureScreen(driver, id);
			Utilities.assertTextValue(driver, By.xpath(ERROR_MSG_XPATH), expectedMsg);
		}
	}	
}
